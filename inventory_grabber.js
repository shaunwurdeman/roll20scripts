    ...
    var scriptName = '5e OGL Inventory Tracker',
        ...
        filterItemAttrsForCharacterAndSuffixAndValue = function(charId, suffix, value){
            return filterObjs(function(obj){
                // sendChat(scriptName, '/w gm ' + obj.get('type') + ' ' + obj.get('characterid') + ' ' + obj.get('name') + ' ' + obj.get('current'));
                // if (obj.get('characterid') === charId){
                //     log("type: " + obj.get('type'));
                //     log("name: " + obj.get('name'));
                //     log("current: " + obj.get('current'));
                // }
                suffix = "itemname"
